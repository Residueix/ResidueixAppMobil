...
public class ListAdapterPuntsRecollida extends RecyclerView.Adapter<ListAdapterPuntsRecollida.ViewHolder> {
    private ArrayList<PuntRecollida> mData;
    private LayoutInflater mInflater;
    private Context context;
    private List<PuntRecollida> fullList;
     ...
     */
        public ListAdapterPuntsRecollida(ArrayList<PuntRecollida> itemList, Context context) {
    ...
    @NonNull
    @Override
    public ListAdapterPuntsRecollida.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.list_element, null);
        return new ListAdapterPuntsRecollida.ViewHolder(view);
    }
     ...
     */
    @Override
    public void onBindViewHolder(final ListAdapterPuntsRecollida.ViewHolder holder, final int position) {
        holder.bindData(mData.get(position));

        holder.itemView.setOnClickListener(view -> {
            AlertDialog.Builder builder = new AlertDialog.Builder(context);
            builder.setTitle(mData.get(position).getNom_punt());
     ...
     */
    public void setItems(List<PuntRecollida> items) {
        mData = (ArrayList<PuntRecollida>) items;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tVTitolPuntRecollida;
        TextView tVDescripcioPuntRecollida;
        ...
        ViewHolder(View itemView) {
            ...
            tVTitolPuntRecollida = itemView.findViewById(R.id.tVTitolResidu);
            tVDescripcioPuntRecollida = itemView.findViewById(R.id.tVDescripcioResidu);
        }
         ...
         */
        void bindData(final PuntRecollida item) {
            String imageURL = "http://10.2.136.45/residueix/img/residus/" + item.getImatge();

            Glide.with(context).load(imageURL).into(iconCardView);
            tVTitolPuntRecollida.setText(String.valueOf(item.getNom_punt()));
            tVDescripcioPuntRecollida.setText(item.getNom_provincia());
        }
    }
}
