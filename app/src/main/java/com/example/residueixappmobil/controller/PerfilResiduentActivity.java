        ...
        call.enqueue(new Callback<>() {
            ...
            public void onResponse(Call<ResponseBaixa> call, Response<ResponseBaixa> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(PerfilResiduentActivity.this, responseBaixa.getDescripcio(), Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<ResponseBaixa> call, Throwable t) {
                Toast.makeText(PerfilResiduentActivity.this, "Error: " + t.getMessage(), Toast.LENGTH_LONG).show();
                System.out.println("Error: " + t.getMessage());

                Toast.makeText(PerfilResiduentActivity.this, "Error de red", Toast.LENGTH_SHORT).show();
            }
        });
    }
            ...
            public void onResponse(Call<ResponseConsultaUsuari> call, Response<ResponseConsultaUsuari> response) {
                if (response.isSuccessful()) {
                    ...
                    if (responseConsultaUsuari.getCodiError().equals("0")) {
                        ...
                        editor.apply();
                        Intent intentCanviContrasenya = new Intent(PerfilResiduentActivity.this, CanviContrasenyaActivity.class);
